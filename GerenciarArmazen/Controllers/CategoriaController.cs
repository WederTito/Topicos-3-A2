...
namespace GerenciarArmazen.Controllers
{
    public class CategoriaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Medida")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Medida")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
