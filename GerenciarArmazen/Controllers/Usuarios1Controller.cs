...
namespace GerenciarArmazen.Controllers
{
    public class Usuarios1Controller : Controller
    {
        ...
        public Usuarios1Controller(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Matricula,Senha,Gerente")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Matricula,Senha,Gerente")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
