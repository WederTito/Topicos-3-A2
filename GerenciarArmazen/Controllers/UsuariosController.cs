...
namespace GerenciarArmazen.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,Matricula,Gerente")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,Matricula,Gerente")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
