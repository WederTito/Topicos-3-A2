...
namespace GerenciarArmazen.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,mesa")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,mesa")] Pedido pedido)
        {
            if (id != pedido.Id)
            {
                return NotFound();
